...
const PricingCard = ({ serviceObject }) => {
  return (
    <div className="w-[300px] h-[500px] rounded-3xl border-4 border-primary bg-white text-primary flex flex-col p-4 gap-4 items-center cursor-pointer hover:scale-110 transition-all ease-out duration-300">
